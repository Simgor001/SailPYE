...
class Debug(object):
    def __init__(self, os, text_edit: QtWidgets.QTextEdit, temp_path, statusBar: QtWidgets.QStatusBar):
    ...
    def start(self, name):
        ...
        # 启动脚本
        self.add_log('正在启动...')
        self.statusBar.showMessage('正在启动...',2000)
        ...
        self.add_log('启动成功！')
        self.statusBar.showMessage('启动成功！',2000)
